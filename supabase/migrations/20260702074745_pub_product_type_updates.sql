...
create type "public"."publication_type" as enum ('journal_article', 'conference_paper', 'preprint', 'dissertation', 'review_article', 'technical_report', 'other', 'book_chapter', 'book', 'book_review', 'data_paper', 'erratum', 'software_paper');
...
alter table "public"."publications" alter column "type" set data type public.openalex_work_type using "type"::text::public.openalex_work_type;
